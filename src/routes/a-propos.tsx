  ...
  head: () => ({
    meta: [
      { title: "À propos — Recueil des Chants TESP" },
      {
        name: "description",
        content:
          "Le Recueil des Chants TESP rassemble les cantiques du Tabernacle Espérance pour l'assemblée et les conducteurs de chants.",
      },
      { property: "og:title", content: "À propos — Recueil des Chants TESP" },
      {
        property: "og:description",
        content: "L'application des cantiques du Tabernacle Espérance.",
      },
    ],
  }),
  component: APropos,
  ...
  return (
    <AppShell title="À propos" backTo="/">
      <section className="bg-card shadow-soft rounded-lg border p-5 text-center">
        ...
        <p className="text-muted-foreground mt-1 text-sm">Tabernacle Espérance</p>
      ...
      <section className="bg-card shadow-soft mt-4 rounded-lg border p-4">
        ...
        <p className="mt-1 text-sm leading-relaxed">
          Cette application met les cantiques du Tabernacle Espérance à la portée de chaque
